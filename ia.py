...
SIGNAUX = {
    ...
    "colis_livraison": {
        ...
        "mots": ["colis", "livraison", "chronopost", "colissimo", "mondial relay",
                 ...
                 "votre paquet", "point relais", "bloque en douane", "colis prive",
                 "boite aux lettres", "creneau", "livreur", "expedition", "transporteur",
                 "n'a pas pu etre livre", "adresse incomplete", "frais de port"],
    ...
    "faux_proche": {
        "poids": 30,
        "mots": ["j'ai change de numero", "jai change de numero", "nouveau numero",
                 "c'est moi", "cest moi", "coucou maman", "coucou papa",
                 "mon telephone est casse", "telephone casse", "peux-tu m'aider",
                 "j'ai un souci", "peux tu avancer", "je te rembourse"],
        "explication": "Ce message se fait passer pour un proche ayant change de numero. C'est une arnaque tres repandue : verifie en appelant la personne sur son ANCIEN numero avant de repondre.",
    },
    "amende_peage": {
        "poids": 25,
        "mots": ["amende", "contravention", "peage", "stationnement", "majoration",
                 "infraction", "antai", "avis de paiement", "passage non regle",
                 "regularisez", "regulariser votre situation", "impaye"],
        "explication": "Le message evoque une amende ou un peage impaye. Les vraies administrations envoient ces avis par courrier, jamais par SMS avec un lien de paiement.",
    },
    "mobile_money": {
        "poids": 10,
        "mots": ["momo", "mobile money", "moov money", "celtiis cash", "celtiis money",
                 "flooz", "mixx", "wave", "orange money", "portefeuille electronique",
                 "code secret", "code pin", "code de validation", "code otp",
                 "solde", "fcfa", "f cfa", "cfa", "retrait", "depot", "transfert",
                 "recharge", "unite", "credit de communication"],
        "explication": "Le message concerne un service de paiement mobile. Ne communique JAMAIS ton code secret : aucun agent d'un operateur ne te le demandera, ni par appel ni par message.",
    },
    "erreur_transaction": {
        "poids": 35,
        "mots": ["par erreur", "par megarde", "mauvais numero", "faux numero",
                 "retourner l'argent", "renvoyer l'argent", "rembourser la somme",
                 "credite par erreur", "depot par erreur", "verifiez votre solde",
                 "consultez votre solde", "confirmer votre solde", "annuler la transaction"],
        "explication": "Ce message pretend qu'une somme a ete envoyee par erreur sur ton compte. C'est l'arnaque la plus repandue en Afrique de l'Ouest : l'escroc n'a rien envoye, il veut te faire payer. Verifie toi-meme ton solde avant toute action.",
    },
    "faux_agent": {
        "poids": 35,
        "mots": ["je suis agent", "agent mtn", "agent moov", "agent celtiis",
                 "je suis du service", "je suis conseiller", "je suis technicien",
                 "votre conseiller", "service technique", "je vous appelle de",
                 "je travaille pour", "mandate par", "habilite par"],
        "explication": "Le message se presente comme venant d'un agent ou d'un service officiel. Les vrais operateurs ne demandent jamais tes codes : raccroche et compose toi-meme le numero officiel.",
    },
...
COMBINAISONS_DANGEREUSES = [
    ("mobile_money", "erreur_transaction"),
    ("mobile_money", "faux_agent"),
    ("mobile_money", "infos_sensibles"),
    ("mobile_money", "appat"),
    ("mobile_money", "urgence"),
